...
class StatusPb :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:common.StatusPb) */ {
 public:
  StatusPb();
  virtual ~StatusPb();
  ...
  private:
  ::common::ErrorCode _internal_error_code() const;
  void _internal_set_error_code(::common::ErrorCode value);
  public:
...
inline ::common::ErrorCode StatusPb::_internal_error_code() const {
...
inline void StatusPb::_internal_set_error_code(::common::ErrorCode value) {

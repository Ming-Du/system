...
_TIME = _descriptor.Descriptor(
  name='Time',
  full_name='common.Time',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sec', full_name='common.Time.sec', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nsec', full_name='common.Time.nsec', index=1,
...
_HEADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='seq', full_name='common.Header.seq', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stamp', full_name='common.Header.stamp', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='frame_id', full_name='common.Header.frame_id', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='module_name', full_name='common.Header.module_name', index=3,

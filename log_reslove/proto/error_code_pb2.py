...
_STATUSPB = _descriptor.Descriptor(
  name='StatusPb',
  full_name='common.StatusPb',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error_code', full_name='common.StatusPb.error_code', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='msg', full_name='common.StatusPb.msg', index=1,

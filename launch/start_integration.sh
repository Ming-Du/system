...
echo $HOME
source $HOME/autopilot/install/setup.sh
...
TRAFFIC_LIGHT="roslaunch src/perception/traffic_light/launch/traffic_light.launch"
...
gnome-terminal	--window -e "bash -c '$GLOG_COMMAND && $ROSCORE';bash" -t "core" \
        ...
        --tab -e "bash -c 'sleep 2';bash";$SEND_CONTROL_COMMAND

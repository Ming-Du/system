...
_VEHICLECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='new_jinlv', full_name='chassis.VehicleConfig.new_jinlv', index=23,
